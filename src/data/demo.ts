  ...
  rounds: [
    ...
    // Friday PM — Four-Ball (Match Play, 18 pts)
    {
      ...
      matches: [
        ...
        { id: 'r2-m2', roundId: 'r2', groupNumber: 2, teeTime: '1:10 PM', format: 'four-ball' as const, team1: { teamId: 'morning-woods' as const, playerIds: ['mw-11', 'mw-2'] }, team2: { teamId: 'chip-endels' as const, playerIds: ['ce-5', 'ce-4'] }, holes: makeEmptyHoles(), status: 'complete' as const, result: null, manualResult: { team1Points: 0.5, team2Points: 2.5 } },
        { id: 'r2-m3', roundId: 'r2', groupNumber: 3, teeTime: '1:20 PM', format: 'four-ball' as const, team1: { teamId: 'morning-woods' as const, playerIds: ['mw-8', 'mw-6'] }, team2: { teamId: 'chip-endels' as const, playerIds: ['ce-6', 'ce-3'] }, holes: makeEmptyHoles(), status: 'complete' as const, result: null, manualResult: { team1Points: 1.5, team2Points: 1.5 } },
        { id: 'r2-m4', roundId: 'r2', groupNumber: 4, teeTime: '1:30 PM', format: 'four-ball' as const, team1: { teamId: 'morning-woods' as const, playerIds: ['mw-10', 'mw-7'] }, team2: { teamId: 'chip-endels' as const, playerIds: ['ce-2', 'ce-12'] }, holes: makeEmptyHoles(), status: 'complete' as const, result: null, manualResult: { team1Points: 0, team2Points: 3 } },
        { id: 'r2-m5', roundId: 'r2', groupNumber: 5, teeTime: '1:40 PM', format: 'four-ball' as const, team1: { teamId: 'morning-woods' as const, playerIds: ['mw-5', 'mw-12'] }, team2: { teamId: 'chip-endels' as const, playerIds: ['ce-1', 'ce-9'] }, holes: makeEmptyHoles(), status: 'complete' as const, result: null, manualResult: { team1Points: 1, team2Points: 2 } },
